...
% 1. Navigate 'Current Folder' on the left panel of Matlab to the folder containing this code
% 2. Change file name to be analyzed on line 12
% 3. Run
% 4. Verify signals recognized by program marked red
% 5. Read the total count in the 'Command Window' below

clear
clc
close all

input_img = '20200930-5.0_6_6.7-1_ch00.tif';% Specify the filename here
load net;
